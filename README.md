...
Third Year Scala Project @ EPFL ([CS-320 course](https://edu.epfl.ch/coursebook/en/computer-language-processing-CS-320))

by Szabina Horváth-Mikulas, Eloi Garandel, Erik Wengle and Raoul Gerber
...
The report pdf file gives a brief explanation of the overall project and the extension we made.
